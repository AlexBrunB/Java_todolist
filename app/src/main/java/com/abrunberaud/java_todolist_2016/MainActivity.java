        ...
        lvItems.setOnItemLongClickListener(
                new AdapterView.OnItemLongClickListener() {
                    ...
                    public boolean onItemLongClick(AdapterView<?> adapter,
                        ...
                        Log.d("Split", items.get(pos));
                        String tmp = items.get(pos);
                        title.setText(items.get(pos).split(" - ")[0]);
                        content.setText(items.get(pos).split(" - ")[1]);
                        date.setText(items.get(pos).split(" - ") [2]);
                                ...
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int id) {
                                        if (title.getText().toString().equals("")
                                            ...
                                            String res = title.getText().toString().replace("-", " ")
                                                    + " - " + content.getText().toString().replace("-", " ")
                                                    + " - " + date.getText().toString().replace("-", " ");
                                            items.set(Npos, res);
